...
public class CategoryWeekActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Navigation.setUp(this, this, Navigation.CATEGORY_WEEK);
        ...
        _syncReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                runOnUiThread(CategoryWeekActivity.this::loadData);
            }
        };
    ...
    protected void onResume() {
        ...
        Navigation.select(this, Navigation.CATEGORY_WEEK);
    ...
    private void setUpSwipe() {
        int[] swipeableIds = {R.id.category_week_container, R.id.week_chart,
                R.id.category_week_expense_list};

        for (int id : swipeableIds) {
            final boolean isContainer = id == R.id.category_week_container;
    ...
    private void loadData() {
        ...
        List<CategoryAmount> list = DBHelper.GetCategoryAmountsForWeek(_budget.UniqueId,
                _daysBackFromToday, _budget.StartDay, this.getString(R.string.uncategorized));

        CategoryChart.populate(findViewById(R.id.week_chart), list);
    }
    ...
    public boolean onNavigationItemSelected(int position, long id) {
        return ScreenSwitcher.onNavigationItemSelected(this, Navigation.CATEGORY_WEEK, position);
    }
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        List<Expense> expenses = DBHelper.GetExpensesForCategoryForWeek(_budget.UniqueId,
                c.CategoryId != null ? c.CategoryId.toString() : null, _daysBackFromToday, _budget.StartDay);
    ...
    private void hideDetails() {
        ...
        CategoryChart.clearHighlights(findViewById(R.id.week_chart));
    }
